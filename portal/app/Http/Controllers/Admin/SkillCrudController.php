...
class SkillCrudController extends Controller
{
    ...
    {
        $answer_key_pdf = $request->file('pdf_file')->store('answer_pdf');
        $request->request->add(['answer_key_pdf' => $answer_key_pdf]);
        $request = $request->except(['pdf_file']);
        //Skill::create($request->validated());
        Skill::create($request);
        return redirect()->back()->with('successMessage', 'Book was successfully added!');
    }
    ...
    public function update(UpdateSkillRequest $request, $id)
    {
        ...
        return redirect()->back()->with('successMessage', 'Book was successfully updated!');
    }
