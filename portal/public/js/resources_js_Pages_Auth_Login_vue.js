...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    title: function title() {
      console.log('title', this.$page.props);
          ...
          [
            ...
            _vm.footerSettings.enable_social_links
              ? _c(
                  ...
                  [
                    _vm._l(_vm.footerSettings.social_links, function(
                      socialLink,
                      key
                    ) {
                      return [
                        socialLink[1]
                          ? _c(
                              "a",
                              {
                                ...
                                attrs: { href: socialLink[2], target: "_blank" }
                              },
                              [
            ...
            _vm.footerSettings.enable_links
              ? _c("div", { staticClass: "my-6 text-base text-color f-f-l" }, [
                  _c(
                    ...
                    [
                      _vm._l(_vm.footerSettings.footer_links, function(
                        footerLink
                      ) {
                        return [
                          footerLink[2]
  ...
  return _c(
    ...
    [
      _c(
        ...
        [_vm._v(_vm._s(_vm.__("Member Login")))]
      ),
      _vm._v(" "),
