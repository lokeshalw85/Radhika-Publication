    ...
    <div class="overflow-y-auto h-screen px-2">
        ...
        <form v-else class="my-6 w-11/12 mx-auto xl:w-full xl:mx-0" @submit.prevent="submitForm">
            <div class="w-full flex flex-col mb-6">
                <label for="name" class="pb-2 font-semibold text-gray-800">{{ __('Lesson') }} {{ __('Name') }}</label>
                <InputText type="text"
                           id="name"
                           v-model="form.name"
                           :placeholder="__('Lesson')" aria-describedby="name-help"
            ...
            <div class="w-full flex flex-col mb-6">
                <label for="skill" class="pb-2 font-semibold text-gray-800">{{ __('Book') }}<span class="ml-1 text-red-400">*</span></label>
